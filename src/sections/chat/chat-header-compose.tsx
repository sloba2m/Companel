      ...
      <Stack mt={0.7} gap={2} sx={{ flex: 1 }}>
        ...
        <Box display="flex" sx={{ flex: 1, width: '100%' }} gap={2}>
          <Box display="flex" sx={{ flex: 1 }}>
            <Box
              sx={{ display: 'flex', flexDirection: 'column', flexWrap: 'wrap', gap: 2, flex: 0 }}
            >
              {[t('conversations.createForm.to'), 'Cc'].map((label) => (
                <Typography
                  key={label}
                  variant="subtitle2"
                  sx={{ color: 'text.primary', my: 1.1, width: '40px' }}
                >
                  {label}:
                </Typography>
              ))}
            ...
            <Box
              sx={{ display: 'flex', flexDirection: 'column', flexWrap: 'wrap', gap: 2, flex: 1 }}
            >
              <TextField
            ...
            >
              {[
                ...
                <Typography
                  key={label}
                  variant="subtitle2"
                  sx={{ color: 'text.primary', my: 1.1, width: '60px' }}
                >
                  {label}:
                </Typography>
              ))}
